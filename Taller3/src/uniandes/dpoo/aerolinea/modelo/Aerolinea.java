...
public class Aerolinea
{
    ...
    {
    	Vuelo result = null; 
    	for(int i = 0; i < vuelos.size() && result == null; i++) {
    		Vuelo vueloA = vuelos.get(i); 
    		if((vueloA.getRuta().getCodigoRuta() == codigoRuta)&&(vueloA.getFecha() == fechaVuelo)) {
    			result = vueloA;
    		}
    	}
        return result;
